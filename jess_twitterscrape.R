...
raw_tweets1 <- search_tweets(q = "\"Geothermal energy\"", n = 5000, include_rts = FALSE, lang = "en")
raw_tweets2 <- search_tweets(q = "\"Geothermal heating\"", n = 5000, include_rts = FALSE, lang = "en")
raw_tweets3 <- search_tweets(q = "\"Geothermal cooling\"", n = 5000, include_rts = FALSE, lang = "en")
